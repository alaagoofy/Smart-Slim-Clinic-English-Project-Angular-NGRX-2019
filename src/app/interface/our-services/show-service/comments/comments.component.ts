...
export class CommentsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.commentsServices.setComments(this.serviceKey);
  ...
  save(comment) {
    ...
    this.commentsServices.addComment(finalComment, this.serviceKey).subscribe();
    this.commentText = '';
  }
  ...
  // --------------------------------Edit Comment
  edit(i: number, id: string, comment: Comment) {
    let finalComment = {
      userName: this.user.name,
      userEmail: this.user.email,
      comment: comment,
    ...
    this.commentsServices.updateComment(i, id, finalComment, this.serviceKey).subscribe();
    (document.querySelector('.' + id) as HTMLElement).style.display = 'block';
    this.editedComment = '';
  }
